                ...
                <div className="p-8">
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            {[
                                { label: 'MONITOR YOUR MOOD', color: 'lime-400', hoverColor: 'lime-500', delay: 0 },
                                { label: 'QUICK QUIZ', color: 'lime-300', hoverColor: 'lime-400', delay: 100 },
                                { label: "TODAY'S TIP", color: 'lime-200', hoverColor: 'lime-300', delay: 200 }
                            ].map((btn, idx) => (
                                <button
                                    key={idx}
                                ...
                                >
                                    <span className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 translate-x-full group-hover:translate-x-fulltransition-transform duration-700"></span>
